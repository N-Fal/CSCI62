...
public:
    ...
    void setupUi(QMainWindow *SocialNetworkWindow)
    {
        ...
        addButton->setGeometry(QRect(300, 50, 221, 24));
        postsTable = new QTableWidget(centralwidget);
        postsTable->setObjectName("postsTable");
        postsTable->setGeometry(QRect(280, 80, 256, 401));
        sendEdit = new QLineEdit(centralwidget);
        sendEdit->setObjectName("sendEdit");
        sendEdit->setGeometry(QRect(300, 490, 221, 24));
        sendBox = new QCheckBox(centralwidget);
        sendBox->setObjectName("sendBox");
        sendBox->setGeometry(QRect(290, 520, 78, 22));
        sendButton = new QPushButton(centralwidget);
        sendButton->setObjectName("sendButton");
        sendButton->setGeometry(QRect(440, 520, 80, 24));
    ...
    void retranslateUi(QMainWindow *SocialNetworkWindow)
    {
        ...
        sendBox->setText(QCoreApplication::translate("SocialNetworkWindow", "public?", nullptr));
        sendButton->setText(QCoreApplication::translate("SocialNetworkWindow", "Send", nullptr));
    } // retranslateUi
