...
public:
    ...
    // pre: the user is on a profile page
    // post: likes or unlikes the selected post
    ...
    // pre: the user is on a profile page
    // post: the contents of sendField and sendBox are uploaded to the current page as a post
    void sendPost();
    ...
    // pre: none
    // post: calls the writePosts() method of the network
    void savePostsFile();
